...
def load_lfm(res, args=None):
    ...
    try:
        ...
        print(f"[load_lfm] could not load {vae_ckpt} ({e}), falling back to 'ariG23498/vae-cifar10'")
        vae = AutoencoderKL.from_pretrained("ariG23498/vae-cifar10").to(device) # stabilityai/sd-vae-ft-mse
    vae.eval()
